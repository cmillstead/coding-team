...
| Skill | Path | Purpose |
|-------|------|---------|
| `/a11y` | `skills/a11y/SKILL.md` | **DISABLED** (off in skillOverrides) — WCAG 2.2 AA source code audit |
| `/api-qa` | `skills/api-qa/SKILL.md` | **DISABLED** (off in skillOverrides) — API endpoint testing |
...
| `/migration-guide` | `skills/migration-guide/SKILL.md` | **DISABLED** (off in skillOverrides) — upgrade/migration guides for breaking changes |
| `/onboard` | `skills/onboard/SKILL.md` | **DISABLED** (off in skillOverrides) — guided orientation to an unfamiliar codebase |
