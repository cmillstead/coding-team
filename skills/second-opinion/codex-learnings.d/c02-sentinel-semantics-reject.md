...
**Design default:** Before adding any "reject N/empty" validation, grep every consumer of the field and confirm none treats that value as a sentinel, disable flag, or default mode — only then is the rejection safe.
