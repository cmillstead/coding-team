...
- **Use real implementations in tests** — only mock dependencies genuinely impossible to run locally — see `rules/test-files.md` for the full criteria. Never mock the thing being tested.
