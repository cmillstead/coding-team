...
**Superseded by:** `2026-06-07-deploy-script-symlinks-not-copies.md` — deploy.sh's mechanism changed from copying files to creating relative symlinks (PR #69), making the drift class this record describes structurally impossible rather than merely detected.
