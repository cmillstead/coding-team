...
Once the edit lands, write-guard is active for the duration of Phase 5: orchestrator direct Edit/Write to instruction files (`agents/`, `cookbook/phases/`, `phases/`, `prompts/`, `skills/`, `CLAUDE.md`, hooks) will be blocked, forcing all instruction-file work through the Agent tool.
