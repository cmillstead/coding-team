...
def _compound_allow_overridden() -> bool:
    """True if the operator has disabled compound-command hygiene via env flag."""
    return os.environ.get(COMPOUND_ALLOW_OVERRIDE_ENV, "").strip().lower() in (
        "1", "true", "yes", "on"
    )
