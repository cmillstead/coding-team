...
style decides HOW those fields read. You owe the user both, in every reply.
...
the thing the user must act on, show it and label it in plain words.
...
> This sentence also appears in the active output-style file and in `~/.claude/CLAUDE.md`. Reword all three together.
